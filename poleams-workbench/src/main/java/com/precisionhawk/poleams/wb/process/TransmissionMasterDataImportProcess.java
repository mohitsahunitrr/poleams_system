...
import com.precisionhawk.poleams.processors.translineinspection.ShapeFileMasterDataImport;
import java.io.File;
 ...
 * @author pchapman
 */
public class TransmissionMasterDataImportProcess extends ServiceClientCommandProcess {
...
//        GeoJson(ARG_FEEDER_ID),
    ...
    private static final String COMMAND = "importTransMasterData";
    private static final String HELP = "\t" + COMMAND + " " + ARGS_FOR_HELP + " " + ARG_TYPE + " inputType [" + ARG_ORG_ID + " organizationId] " + ARG_ORDER_NUM + " WorkOrderNumber path/to/inspection/data/dir";
