...
public class DataImportUtilities {
    ...
    public static boolean ensureFeeder(WSClientHelper svcs, InspectionData data, ProcessListener listener, String feederNum, String subStationName) throws IOException {
        ...
        if (fi == null) {
            ...
            if (fi == null) {
                ...
                fi.setStatus(new SiteInspectionStatus("Processed"));
