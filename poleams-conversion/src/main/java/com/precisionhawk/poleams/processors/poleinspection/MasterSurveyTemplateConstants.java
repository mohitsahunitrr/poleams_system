...
public interface MasterSurveyTemplateConstants {
    ...
    static final int COL_POLE_SPAN_1_LEN = 9;
    static final int COL_POLE_SPAN_2_LEN = 10;
    static final int COL_POLE_SPAN_3_LEN = 11;
    static final int COL_POLE_SPAN_4_LEN = 12;
    ...
    // Estimated Cost = 88
    // New Wind Rating = 89
    static final int COL_LAT_LONG_DELTA = 90;
